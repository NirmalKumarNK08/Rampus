...
const MusicBand = () => {
  ...
  return (
    <div className='w-full h-auto flex flex-col mt-2 sm:mt-0 md:justify-start items-center'>
      <h1 className='text-3xl mt-20 md:mt-10 gradient-text text-center font-extrabold'>MUSIC BAND</h1>
      <div className='h-auto bg-white text-black bg-opacity-75 rounded-xl shadowContainer w-5/6 mb-20 mt-5 flex flex-col items-center justify-center p-3 pb-8'>
        ...
        <div className='px-5 text-lg flex flex-col gap-2'>
          <p className='mt-5'> {"->"} Participants limit-5-7.</p>
          <p> {"->"} Time limit-4 mins.</p>
          <p> {"->"} Participants should bring their own instruments.</p>
          <p> {"->"} Band members are responsible for all their own equipment and personal items.</p>
        </div>
        ...
        <div className='flex flex-col justify-center items-center w-full md:flex-row mt-5 gap-5'>
            <div className={`${card}`}>
               <p className='text-xl font-bold'>Anbu raj</p>
               <p className='text-sm'>9940493735</p>
            </div>
            <div className={`${card}`}>
               <p className='text-xl font-bold'>Asvin</p>
               <p className='text-sm'>7358595937</p>
            </div>
         </div>
      </div>
    </div>
